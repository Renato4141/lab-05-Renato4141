...
Create a new, empty repository on GitHub (no README, no .gitignore, no license — completely empty). Make sure it is public so the teaching assistant can review it.

In your local vet_clinic project from Lab 4, add the new repository as a remote and push your code:

cd vet_clinic
git remote add lab5 <your-new-repo-url>
git push -u lab5 main
Verify on GitHub that your code is now in the new repository.

From now on, push your Lab 5 work to this new remote:

git push lab5 main
Submit the link to your new repository on Canvas.
Instructions
1. Validations
